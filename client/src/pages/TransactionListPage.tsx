                  ...
                  <tbody className="divide-y">
                    {transactions.map((tx: any) => editingId === tx.id ? (
                      ...
                      <tr key={tx.id} className="hover:bg-muted/50 transition-colors">
                        ...
                        <td className="px-4 py-3.5 max-w-[200px] truncate font-medium">
                          {tx.description || '—'}
                          {tx.isAutoGenerated && <Badge variant="outline" className="ml-1.5 text-[9px] px-1 py-0 align-middle">Auto</Badge>}
                        </td>
