...
import { LayoutDashboard, Receipt, TrendingUp, PiggyBank, Tags, Sun, Moon, PanelLeftClose, PanelLeft, Menu, LogOut, Settings } from 'lucide-react';
      ...
      <aside className={cn(
        ...
        <div className="border-t border-sidebar-border p-3 space-y-1">
          ...
          <Button variant="ghost" size="icon" onClick={() => setCollapsed((c) => !c)}
            className="hidden md:flex w-full text-sidebar-foreground/70 hover:text-sidebar-foreground">
